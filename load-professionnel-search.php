...
<div class="categorie-recherche-personnalise">
    ...
    <div class="sous-categorie-recherche-personnalise">
        ...
        ?>
        <a href="recherche/profesionnel/<?php echo $categories_services_row['sous_categories'] ?>"><?php echo $categories_services_row['sous_categories'] ?></a>
        <?php } ?>
    </div>
    <div class="categorie-recherche-personnalise-button">
    ...
    <div class="sous-categorie-recherche-personnalise">
        ...
        ?>
        <a href="recherche/profesionnel/<?php echo $categories_artisants_row['sous_categories'] ?>"><?php echo $categories_artisants_row['sous_categories'] ?></a>
        <?php } ?>
    </div>
    <div class="categorie-recherche-personnalise-button">
    ...
    <div class="sous-categorie-recherche-personnalise">
        ...
        ?>
        <a href="recherche/profesionnel/<?php echo $categories_transports_row['sous_categories'] ?>"><?php echo $categories_transports_row['sous_categories'] ?></a>
        <?php } ?>
    </div>
    <div class="categorie-recherche-personnalise-button">
    ...
    <div class="sous-categorie-recherche-personnalise">
        ...
        ?>
        <a href="recherche/profesionnel/<?php echo $categories_locations_row['sous_categories'] ?>"><?php echo $categories_locations_row['sous_categories'] ?></a>
        <?php } ?>
    </div>
    <div class="categorie-recherche-personnalise-button">
    ...
    <div class="sous-categorie-recherche-personnalise">
        ...
        ?>
        <a href="recherche/profesionnel/<?php echo $categories_entreprises_row['sous_categories'] ?>"><?php echo $categories_entreprises_row['sous_categories'] ?></a>
        <?php } ?>
    </div>
    <div class="categorie-recherche-personnalise-button">
    ...
    <div class="sous-categorie-recherche-personnalise">
        ...
        ?>
        <a href="recherche/profesionnel/<?php echo $categories_detaillons_row['sous_categories'] ?>"><?php echo $categories_detaillons_row['sous_categories'] ?></a>
        <?php } ?>
    </div>
    <div class="categorie-recherche-personnalise-button">
    ...
    <div class="sous-categorie-recherche-personnalise">
        ...
        ?>
        <a href="recherche/profesionnel/<?php echo $categories_grossistes_row['sous_categories'] ?>"><?php echo $categories_grossistes_row['sous_categories'] ?></a>
        <?php } ?>
    </div>
    <div class="categorie-recherche-personnalise-button">
    ...
    <div class="sous-categorie-recherche-personnalise">
        ...
        ?>
        <a href="recherche/profesionnel/<?php echo $categories_fabriquants_row['sous_categories'] ?>"><?php echo $categories_fabriquants_row['sous_categories'] ?></a>
        <?php } ?>
    </div>
    <div class="categorie-recherche-personnalise-button">
    ...
    <div class="sous-categorie-recherche-personnalise">
        ...
        ?>
        <a href="recherche/profesionnel/<?php echo $categories_importation_row['sous_categories'] ?>"><?php echo $categories_importation_row['sous_categories'] ?></a>
        <?php } ?>
    </div>
</div>
<?php
