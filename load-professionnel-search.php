...
if (isset($_SESSION['user'])) {
    ...
    if ($get_session_user_query->execute()) {
        ...
        $get_historique_query = $conn->prepare("SELECT * FROM recherche_historique WHERE id_user = $id_user AND type_rech = 'professionnel' ORDER BY id_r DESC LIMIT 6");
...
?>
<div class="recherche-historique-option" id="search_professionnel_history_option">
    <h4>Historiques de recherche</h4>
    <div id="delete_professionnel_search_history">
        <i class="fas fa-trash"></i>
    </div>
</div>
<div class="recherche-tout-historique" id="search_professionnel_history">
<?php 
                $h = 0;
                while ($get_historique_row = $get_historique_query->fetch(PDO::FETCH_ASSOC)) {
                $h++;
?>  
    <div id="history_professionnel_text_<?php echo $h ?>"><p><?php echo $get_historique_row['text_rech'] ?></p></div>
<?php 
                } 
                if ($get_historique_query->rowCount() == 6) { 
?>
    <div id="show_professionnel_history" style="padding:4px 10px;"><i class="fas fa-chevron-down"></i></div>
<?php       
                } 
?>
</div>    
...
?>
<h4>Catégories des profesionnels et entreprises</h4>
<div class="categorie-recherche-personnalise">
    ...
    <div class="sous-categorie-recherche-personnalise">
        ...
        ?>
        <a href="recherche/professionnel/text/<?php echo $categories_services_row['sous_categories'] ?>"><?php echo $categories_services_row['sous_categories'] ?></a>
        <?php } ?>
    </div>
    <div class="categorie-recherche-personnalise-button">
    ...
    <div class="sous-categorie-recherche-personnalise">
        ...
        ?>
        <a href="recherche/professionnel/text/<?php echo $categories_artisants_row['sous_categories'] ?>"><?php echo $categories_artisants_row['sous_categories'] ?></a>
        <?php } ?>
    </div>
    <div class="categorie-recherche-personnalise-button">
    ...
    <div class="sous-categorie-recherche-personnalise">
        ...
        ?>
        <a href="recherche/professionnel/text/<?php echo $categories_transports_row['sous_categories'] ?>"><?php echo $categories_transports_row['sous_categories'] ?></a>
        <?php } ?>
    </div>
    <div class="categorie-recherche-personnalise-button">
    ...
    <div class="sous-categorie-recherche-personnalise">
        ...
        ?>
        <a href="recherche/professionnel/text/<?php echo $categories_locations_row['sous_categories'] ?>"><?php echo $categories_locations_row['sous_categories'] ?></a>
        <?php } ?>
    </div>
    <div class="categorie-recherche-personnalise-button">
    ...
    <div class="sous-categorie-recherche-personnalise">
        ...
        ?>
        <a href="recherche/professionnel/text/<?php echo $categories_entreprises_row['sous_categories'] ?>"><?php echo $categories_entreprises_row['sous_categories'] ?></a>
        <?php } ?>
    </div>
    <div class="categorie-recherche-personnalise-button">
    ...
    <div class="sous-categorie-recherche-personnalise">
        ...
        ?>
        <a href="recherche/professionnel/text/<?php echo $categories_detaillons_row['sous_categories'] ?>"><?php echo $categories_detaillons_row['sous_categories'] ?></a>
        <?php } ?>
    </div>
    <div class="categorie-recherche-personnalise-button">
    ...
    <div class="sous-categorie-recherche-personnalise">
        ...
        ?>
        <a href="recherche/professionnel/text/<?php echo $categories_grossistes_row['sous_categories'] ?>"><?php echo $categories_grossistes_row['sous_categories'] ?></a>
        <?php } ?>
    </div>
    <div class="categorie-recherche-personnalise-button">
    ...
    <div class="sous-categorie-recherche-personnalise">
        ...
        ?>
        <a href="recherche/professionnel/text/<?php echo $categories_fabriquants_row['sous_categories'] ?>"><?php echo $categories_fabriquants_row['sous_categories'] ?></a>
        <?php } ?>
    </div>
    <div class="categorie-recherche-personnalise-button">
    ...
    <div class="sous-categorie-recherche-personnalise">
        ...
        ?>
        <a href="recherche/professionnel/text/<?php echo $categories_importation_row['sous_categories'] ?>"><?php echo $categories_importation_row['sous_categories'] ?></a>
        <?php } ?>
    </div>
</div>
<?php
