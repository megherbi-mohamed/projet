...
$create_images_query = $conn->prepare("INSERT INTO promotions_media (id_prm,id_user,media_url,media_type,etat) VALUES (:id_prm,:id_user,:media_url,:media_type,:etat)");
