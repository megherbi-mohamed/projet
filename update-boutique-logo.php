...
$query = "UPDATE boutiques SET logo_btq = 'boutique-logo/$imageName' WHERE id_btq = '$id_btq'";
...
// /* Location */
// $location = "boutique-logo/".$NewImageName;
// $uploadOk = 1;
...
// }
// else{
//     $query = "UPDATE boutiques SET logo_btq = '$location' WHERE id_btq = '$idBoutique'";
//     if(mysqli_query($conn, $query)){
