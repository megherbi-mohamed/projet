...
<div class="all-user-notifications">
<?php
$i=0;
...
<div class="notification-setting" id="notification_<?php echo $i ?>">
    <div class="notification-setting-container" style="<?php echo $new_ntf ?>">
        <?php if ($get_sender_info_row['img'] == '') { ?>
        <img src="./images/profile.png" alt="">
        <?php }else{ ?>
        <img src="<?php echo $get_sender_info_row['img'] ?>" alt="">
        <?php } ?>
        <div class="notification-setting-message">
            <p><?php echo $get_sender_info_row['nom'].' '.$get_ntf_row['message_ntf']; ?></p>
            <span><?php echo $get_ntf_row['date_ntf'] ?></span>
        </div>
        <div class="notification-setting-image">
...
<div class="notification-setting" id="notification_pub_<?php echo $i ?>">
    <div class="notification-setting-container" style="<?php echo $new_ntf1 ?>">    
        <?php if ($get_sender_info_row['img'] == '') { ?>
        <img src="./images/profile.png" alt="">
        <?php }else{ ?>
        <img src="<?php echo $get_sender_info_row['img'] ?>" alt="">
...
<div class="notification-setting" id="notification_prd_<?php echo $i ?>">
    <div class="notification-setting-container" style="<?php echo $new_ntf1 ?>">    
        <?php if ($get_sender_info_row['img'] == '') { ?>
        <img src="./images/profile.png" alt="">
        <?php }else{ ?>
...
<input type="hidden" id="id_ntf_<?php echo $i ?>" value="<?php echo $get_ntf_row['id_ntf'] ?>">
<div class="notification-setting" id="notification_abn_<?php echo $i ?>" style="grid-template-columns: 20% 80%;">
    <div class="notification-setting-container" style="<?php echo $new_ntf ?>">    
        <?php if ($get_sender_info_row['img'] == '') { ?>
        <img src="./images/profile.png" alt="">
        <?php }else{ ?>
