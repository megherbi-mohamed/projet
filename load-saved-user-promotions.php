...
$get_all_promotions_query = $conn->prepare("SELECT * FROM promotions WHERE id_prm IN (SELECT id_prm FROM promotions_enregistres WHERE id_user = $id_user) ORDER BY id_prm DESC");
...
<div class="promotion-overview">
    ...
    <div class="promotion-overview-right">
        ...
        <div class="promotion-overview-right-middle">
            ...
            <p><?php echo $get_all_promotions_row['ville_prm'].', '.$get_all_promotions_row['commune_prm'] ?></p>
        </div>
