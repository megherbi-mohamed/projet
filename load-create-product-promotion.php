...
$ville_prm = htmlspecialchars($_POST['ville_promotion']);
$commune_prm = htmlspecialchars($_POST['commune_promotion']);
...
$etat = 1;
$create_promotion_query = $conn->prepare("UPDATE promotions SET titre_prm = '$titre_prm', categorie_prm = '$categorie_prm', sous_categorie_prm = '$sous_categorie_prm', ville_prm = '$ville_prm', commune_prm = '$commune_prm', adresse_prm = '$adresse_prm', 
...
if ($create_promotion_query->execute()){
