...
$imageName = time().$id_prm.'.png';
$path = $upload_location.$imageName;
$create_images_query = $conn->prepare("INSERT INTO promotions_media (id_prm,id_user,media_url,media_type,etat,etat_updt) VALUES (:id_prm,:id_user,:media_url,:media_type,:etat,:etat_updt)");
