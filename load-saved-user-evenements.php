...
$get_all_evenements_query = $conn->prepare("SELECT * FROM evenements WHERE id_evn IN (SELECT id_evn FROM evenements_enregistres WHERE id_user = $id_user) ORDER BY id_evn DESC");
