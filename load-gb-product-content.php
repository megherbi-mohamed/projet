    ...
    <div class="product-details-bottom-bottom">
        ...
        <div class="product-details-bottom-bottom-comments" id="comments_product">
            <div class="type-product-comment">
                ...
                <input type="hidden" id="commentaire_img_user" value="<?php echo $btq_inf_row['logo_btq'] ?>">
                <input type="hidden" id="commentaire_nom_user" value="<?php echo $btq_inf_row['nom_btq'] ?>">
                <input type="hidden" id="id_prd" value="<?php echo $get_prd_row['id_prd'] ?>">
                <input type="hidden" id="id_user_comment" value="<?php echo $btq_inf_row['id_btq'] ?>">
            </div>
