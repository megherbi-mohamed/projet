...
$create_images_query = $conn->prepare("INSERT INTO evenements_media (id_evn,id_user,media_url,media_type,etat) VALUES (:id_evn,:id_user,:media_url,:media_type,:etat)");
