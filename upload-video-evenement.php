...
$videoName = time().$id_evn.'.mp4';
$path = $upload_location.$videoName;
$create_video_query = $conn->prepare("INSERT INTO evenements_media (id_evn,id_user,media_url,media_type,etat,etat_updt) VALUES (:id_evn,:id_user,:media_url,:media_type,:etat,:etat_updt)");
$create_video_query->bindParam(':id_evn',$id_evn);
