...
latitude_prm = $latitude_prm, longitude_prm = $longitude_prm, date_debut_prm = '$date_debut_prm', date_fin_prm = '$date_fin_prm', description_prm = '$description_prm' WHERE id_prm = $id_prm");
$get_promotion_media_query = $conn->prepare("SELECT * FROM promotions_media WHERE id_prm = $id_prm");
if($update_promotion_query->execute() && $get_promotion_media_query->execute()){
